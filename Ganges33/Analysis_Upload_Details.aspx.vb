    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Try
            ...
            If IsPostBack = False Then
                ...
                lblLocationValue.Text = "<b>Target Store: </b></br>" & hdnStoreID.Value
                lblDateFrom.Text = "<b>From Date(YYYY-MM-DD):</b></br>" & CType(Session("ExportTaskInputDtl"), Export_File_Parameter_Details).DateFrom
                lblDateTo.Text = "<b>To Date(YYYY-MM-DD):</b></br>" & CType(Session("ExportTaskInputDtl"), Export_File_Parameter_Details).DateTo
                lblActive.Text = "<b>Active :</b></br>" & IIf(CType(Session("ExportTaskInputDtl"), Export_File_Parameter_Details).IsActive = "0", "Yes", "False")
