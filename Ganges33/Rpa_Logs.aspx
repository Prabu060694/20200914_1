<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/RpaSub.Master" CodeBehind="Rpa_Logs.aspx.vb" Inherits="Ganges33.Rpa_Logs" %>
...
<ItemStyle HorizontalAlign="Center" VerticalAlign="Middle"></ItemStyle>
<ItemTemplate>
<a onclick="javascript:window.open('Rpa_logview.aspx?id=<%#DataBinder.Eval(Container.DataItem, "logview")%>');" href="#" id="a6" ><%#DataBinder.Eval(Container.DataItem, "logview")%></a>
</ItemTemplate>
</asp:TemplateField>
